...
const LivePage = () => {
  ...
  useEffect(() => {
    ...
    let host = params.app === 'esport' ? 'http://43.198.31.221:8281' : 'http://121.11.44.79:8281'
  ...
  const handleClick = (e, app, stream) => {
    ...
    if (app === 'sport') {
      ...
      text += `http://121.11.44.79:8280/${app}/${stream}.live.flv`
    } else {
      // text += `https://d1z6saveqyrmdf.cloudfront.net/${app}/${stream}.live.flv` + "\n"
      text += `http://43.198.31.221:8280/${app}/${stream}.live.flv`
    }
